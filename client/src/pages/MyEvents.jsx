      ...
      <div style={styles.container}>
        <div style={styles.titleSection}>
          ...
          <p style={styles.subtitle}>
            Manage and monitor event experiences hosted by you.
          </p>
        </div>

        {hostingEvents.length === 0 ? (
          <div style={styles.emptyState}>
            <p style={styles.emptyText}>You haven't hosted any events yet.</p>
          ...
          <div style={styles.grid}>
            {hostingEvents.map((event) => (
              <div key={event._id} className="ticket-card" style={styles.card}>
                ...
                >
                  <span style={styles.visualCoverText}>{event.category || 'Host'}</span>
                </div>
                ...
                <div style={styles.cardInnerBottom}>
                  <div style={styles.metaSection}>
                    ...
                    <div style={styles.metaItem}>👥 {event.attendees?.length || 0} attending</div>
                  </div>
