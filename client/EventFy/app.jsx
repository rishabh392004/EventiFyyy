              ...
              element={
                <div className="fade-in-up" style={{ 
                  ...
                  <h1 style={{ 
                    fontSize: '2.5rem', 
                    fontWeight: 800,
                    background: 'linear-gradient(135deg, #fff, #c4b5fd, var(--primary-color))',
                    ...
                    {user ? `Welcome, ${user.name}` : 'Discover Events'}
                  </h1>
                  <p style={{ 
                    ...
                    {user 
                      ? <Dashboard/> 
                      : 'Sign in to explore and host incredible experiences.'}
                  </p>
                </div>
              } 
            />
